...
//      narrowSuite
  ...
  // TODO: make a decision about Narrow functionality
  ...
  // TODO: delete if we pull Narrow functionality
  def hasDiscriminator(maybeItem: Option[Item])(discriminatorValue: String): Boolean =
    maybeItem match {
