...
//
//object AliasMap2RenderSpec extends ZIOSpecDefault {
//
...
//
//  def avKey(av: AttributeValue) = AliasMap2.AttributeValueKey(av)
//
...
//        suite("basic renders")(
//          test("Between") {
//            val (aliasMap, expression) = between.render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(avKey(two) -> ":v0", avKey(one) -> ":v1", avKey(three) -> ":v2"), 3))) &&
//            assert(expression)(equalTo(":v0 BETWEEN :v1 AND :v2"))
//          },
//          test("In") {
//            val (aliasMap, expression) = in.render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(avKey(one) -> ":v0", avKey(two) -> ":v1"), 2))) &&
//            assert(expression)(equalTo(":v0 IN (:v0, :v1)"))
//          },
//          test("AttributeExists") {
//            val (aliasMap, expression) =
//              attributeExists.render2.execute
//            assert(aliasMap.map)(isEmpty) &&
//            assert(expression)(equalTo(s"attribute_exists($projection)"))
//          },
//          test("AttributeNotExists") {
//            val (aliasMap, expression) =
//              attributeNotExists.render2.execute
//
//            assert(aliasMap.map)(isEmpty) &&
...
//          },
//          test("AttributeType") {
//            val (aliasMap, expression) = attributeType.render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(number -> ":v0"), 1))) &&
//            assert(expression)(equalTo(s"attribute_type($projection, :v0)"))
//          },
//          test("Contains") {
//            val (aliasMap, expression) = contains.render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo(s"contains($projection, :v0)"))
//          },
//          test("BeginsWith") {
//            val (aliasMap, expression) = beginsWith.render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(name -> ":v0"), 1))) &&
...
//              .execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(two -> ":v0", one -> ":v1", three -> ":v2", number -> ":v3"), 4))) &&
...
//              .execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(two -> ":v0"), 1))) &&
...
//              .execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0", three -> ":v1"), 2))) &&
...
//          test("Equals") {
//            val (aliasMap, expression) =
//              SortKeyExpression.Equals(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
...
//          test("LessThan") {
//            val (aliasMap, expression) =
//              SortKeyExpression.LessThan(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo("num < :v0"))
//          },
//          test("NotEqual") {
//            val (aliasMap, expression) =
//              SortKeyExpression.NotEqual(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo("num <> :v0"))
//          },
//          test("GreaterThan") {
//            val (aliasMap, expression) =
//              SortKeyExpression.GreaterThan(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo("num > :v0"))
//          },
//          test("LessThanOrEqual") {
//            val (aliasMap, expression) =
//              SortKeyExpression.LessThanOrEqual(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo("num <= :v0"))
//          },
//          test("GreaterThanOrEqual") {
//            val (aliasMap, expression) =
//              SortKeyExpression.GreaterThanOrEqual(SortKeyExpression.SortKey("num"), one).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
//            assert(expression)(equalTo("num >= :v0"))
//          },
//          test("Between") {
//            val (aliasMap, expression) =
//              SortKeyExpression.Between(SortKeyExpression.SortKey("num"), one, two).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0", two -> ":v1"), 2))) &&
//            assert(expression)(equalTo("num BETWEEN :v0 AND :v1"))
//          },
//          test("BeginsWith") {
//            val (aliasMap, expression) =
//              SortKeyExpression.BeginsWith(SortKeyExpression.SortKey("num"), name).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(name -> ":v0"), 1))) &&
...
//            .execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(two -> ":v0", one -> ":v1", three -> ":v2"), 3))) &&
//          assert(expression)(equalTo("num = :v0 AND num BETWEEN :v1 AND :v2"))
//        }
//      ),
//      suite("AttributeValueType")(
//        test("Bool") {
//          val (aliasMap, expression) = AttributeValueType.Bool.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("BOOL") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("BinarySet") {
//          val (aliasMap, expression) = AttributeValueType.BinarySet.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("BS") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("List") {
//          val (aliasMap, expression) = AttributeValueType.List.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("L") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("Map") {
//          val (aliasMap, expression) = AttributeValueType.Map.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("M") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("NumberSet") {
//          val (aliasMap, expression) = AttributeValueType.NumberSet.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("NS") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("Null") {
//          val (aliasMap, expression) = AttributeValueType.Null.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("NULL") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("StringSet") {
//          val (aliasMap, expression) = AttributeValueType.StringSet.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("SS") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("Binary") {
//          val (aliasMap, expression) = AttributeValueType.Binary.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("B") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("Number") {
//          val (aliasMap, expression) = AttributeValueType.Number.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("N") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        },
//        test("String") {
//          val (aliasMap, expression) = AttributeValueType.String.render2.execute
//
//          assert(aliasMap)(equalTo(AliasMap2(Map(AttributeValue.String("S") -> ":v0"), 1))) &&
//          assert(expression)(equalTo(":v0"))
//        }
//      ),
...
//                ) + UpdateExpression.Action.AddAction($("lastProjection"), one)).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(one -> ":v0"), 1))) &&
...
//              ).render2.execute
//
//            assert(aliasMap)(equalTo(AliasMap2(Map(list -> ":v0"), 1))) &&
