...
object ProjectionExpressionSpec extends DefaultRunnableSpec {
  ...
  object RawProjectionExpressionSuite {
    ...
    private val typeUnsafeOpSuite: ZSpec[Environment, Failure] =
    ...
    private val typeUnsafeFunctionsSuite: ZSpec[Environment, Failure] =
    ...
    private val typeUnsafeComparisonSuite: ZSpec[Environment, Failure] =
    ...
    val typeUnsafeSuite: ZSpec[Environment, Failure] =
  ...
  object TypeSafeSuite {
    private val typeSafeOpSuite: ZSpec[Environment, Failure] =
    ...
    private val typeSafeFunctionsSuite: ZSpec[Environment, Failure] =
    ...
    private val typeSafeComparisonSuite: ZSpec[Environment, Failure] =
      suite("type safe comparison suite")(
        test("PE === X") {
    ...
    val typeSafeSuite: ZSpec[Environment, Failure] =
