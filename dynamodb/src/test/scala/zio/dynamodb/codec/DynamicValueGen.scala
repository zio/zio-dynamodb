...
object DynamicValueGen {
  ...
  def anyDynamicValueOfSchema[A](schema: Schema[A]): Gen[Random with Sized, DynamicValue] =
    schema match {
      ...
      case Schema.Dynamic(_)                                                                                                                                                                       => Gen.oneOf(anyDynamicValueOfSchema(Schema.dynamicValue))       // TODO: Avi - check
      case Schema.SemiDynamic(_, _)                                                                                                                                                                => Gen.const(DynamicValue.Error("SemiDynamic is not supported")) // TODO: Avi
      ...
      case Schema.EitherSchema(left, right, _)                                                                                                                                                     => Gen.oneOf(anyDynamicLeftValueOfSchema(left), anyDynamicRightValueOfSchema(right))
