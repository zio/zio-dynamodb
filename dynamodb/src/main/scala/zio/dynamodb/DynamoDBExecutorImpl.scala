...
case object DynamoDBExecutorImpl {
  ...
  ) = awsExprnAttrNamesAndReplacedFn(escapedExpression)(ZIOAwsConditionExpression(_))
  ...
  ) = awsExprnAttrNamesAndReplacedFn(maybeEscapedExpression)(ZIOAwsConditionExpression(_))
