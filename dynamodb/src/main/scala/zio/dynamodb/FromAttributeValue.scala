...
object FromAttributeValue {
  ...
  implicit val binaryFromAttributeValue: FromAttributeValue[Iterable[Byte]] = {
    ...
    case av                       => Left(DecodingError(s"Error getting binary value. Expected AttributeValue.Binary but found ${av.showType}"))
  }
  ...
  implicit def binarySetFromAttributeValue: FromAttributeValue[Iterable[Iterable[Byte]]] = {
    ...
    case av                            => Left(DecodingError(s"Error getting binary set value. Expected AttributeValue.BinarySet but found ${av.showType}"))
  }

  implicit val booleanFromAttributeValue: FromAttributeValue[Boolean] = {
    case AttributeValue.Bool(b) => Right(b)
    case av                     => Left(DecodingError(s"Error getting boolean value. Expected AttributeValue.Bool but found ${av.showType}"))
  }

  implicit val stringFromAttributeValue: FromAttributeValue[String] = {
    case AttributeValue.String(s) => Right(s)
    case av                       => Left(DecodingError(s"Error getting string value. Expected AttributeValue.String but found ${av.showType}"))
  }

  implicit val shortFromAttributeValue: FromAttributeValue[Short]                   = {
    case AttributeValue.Number(bd) => Right(bd.shortValue)
    case av                        => Left(DecodingError(s"Error getting short value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  implicit val shortSetFromAttributeValue: FromAttributeValue[Set[Short]]           = {
    ...
    case av                              => Left(DecodingError(s"Error getting short set value. Expected AttributeValue.NumberSet but found ${av.showType}"))
  }
  ...
  implicit val intSetFromAttributeValue: FromAttributeValue[Set[Int]]               = {
    ...
    case av                              => Left(DecodingError(s"Error getting int set value. Expected AttributeValue.NumberSet but found ${av.showType}"))
  }
  ...
  implicit val longSetFromAttributeValue: FromAttributeValue[Set[Long]]             = {
    ...
    case av                              => Left(DecodingError(s"Error getting long set value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  implicit val floatFromAttributeValue: FromAttributeValue[Float]                   = {
    case AttributeValue.Number(bd) => Right(bd.floatValue)
    case av                        => Left(DecodingError(s"Error getting float value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  implicit val floatSetFromAttributeValue: FromAttributeValue[Set[Float]]           = {
    ...
    case av                              => Left(DecodingError(s"Error getting float set value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  implicit val doubleFromAttributeValue: FromAttributeValue[Double]                 = {
    case AttributeValue.Number(bd) => Right(bd.doubleValue)
    case av                        => Left(DecodingError(s"Error getting double value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  ...
  implicit val bigDecimalFromAttributeValue: FromAttributeValue[BigDecimal]         = {
    ...
    case av                        => Left(DecodingError(s"Error getting BigDecimal value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  implicit val bigDecimalSetFromAttributeValue: FromAttributeValue[Set[BigDecimal]] = {
    ...
    case av                              => Left(DecodingError(s"Error getting BigDecimal set value. Expected AttributeValue.Number but found ${av.showType}"))
  }
  ...
  implicit def stringSetFromAttributeValue: FromAttributeValue[Set[String]] = {
    ...
    case av                            => Left(DecodingError(s"Error getting string set value. Expected AttributeValue.StringSet but found ${av.showType}"))
  }
  ...
  implicit def iterableFromAttributeValue[A](implicit ev: FromAttributeValue[A]): FromAttributeValue[Iterable[A]] = {
    ...
    case av                        => Left(DecodingError(s"Error getting iterable value. Expected AttributeValue.List but found ${av.showType}"))
  }
