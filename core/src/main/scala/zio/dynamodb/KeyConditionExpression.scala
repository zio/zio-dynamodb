...
object KeyConditionExpr {
  ...
  private[dynamodb] final case class Failure[-From](message: String) extends KeyConditionExpr[From] {
    override def render: AliasMapRender[String] = AliasMapRender.succeed("")
  }
