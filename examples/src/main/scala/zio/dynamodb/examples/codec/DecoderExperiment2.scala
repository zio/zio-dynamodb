...
object DecoderExperiment2 extends App {
  ...
  println(decoder(Schema.primitive[Int])(AttributeValue.Number(BigDecimal("1"))))
  import Models._

  println(fromItem[SimpleCaseClass3](Item("id" -> 1, "name" -> "Avi", "flag" -> true)))

  println(fromItem[NestedCaseClass2](Item("id" -> 2, "nested" -> Item("id" -> 1, "name" -> "Avi", "flag" -> true))))
